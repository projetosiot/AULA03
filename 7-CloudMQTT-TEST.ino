...
#define TOPICO_SUBSCRIBE "MQTTPelicanoEnvia"     //tópico MQTT de escuta
#define TOPICO_PUBLISH   "MQTTPelicanoRecebe"    //tópico MQTT de envio de informações para Broker
...
int BROKER_PORT = ......; // Porta do Broker MQTT
...
void EnviaEstadoOutputMQTT(void)
{
    ...
    Serial.println("- Estado da saida D4 enviado ao broker!");
    delay(1000);
}
